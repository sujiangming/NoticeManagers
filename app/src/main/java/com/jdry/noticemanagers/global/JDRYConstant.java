...
public class JDRYConstant {
   ...
   public static final int INVOKE_API_DEFAULT_TIME = 1;
    ...
    //定义错误类型
    public static final int HTTP_FAIL = 100;
    public static final int HTTP_RESPONSE_FAIL = 101;
    public static final int HTTP_BODY_NULL = 102;
    public static final int HTTP_COMMON_DATA_EMPTY = 103;
    public static final int HTTP_COMMON_STATUS_FAIL = 104;
