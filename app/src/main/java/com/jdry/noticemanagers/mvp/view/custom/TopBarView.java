package com.jdry.noticemanagers.mvp.view.custom;
...
public class TopBarView extends RelativeLayout implements OnClickListener {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.Topbar_titleSize:
                    //dp sp = 3*px 3倍的关系
                    titleTextSize = JDRYUtils.px2dip(context, ta.getDimension(R.styleable.Topbar_titleSize, 0));
                    break;
    ...
    private void initView(Context context) {
        View layout = LayoutInflater.from(context).inflate(R.layout.common_header, this, true);
        ...
        rightTextView = layout.findViewById(R.id.right_text);
