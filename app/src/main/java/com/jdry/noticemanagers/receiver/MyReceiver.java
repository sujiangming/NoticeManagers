    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                //ReadMsgBean readMsgBean = com.alibaba.fastjson.JSONObject.parseObject(content, ReadMsgBean.class);

                //打开自定义的Activity
                Intent intent2 = new Intent(context, MainActivity.class);//ActivityDetail
                //intent2.putExtra("flag", 0);
                //intent2.putExtra("obj", readMsgBean);
